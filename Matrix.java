    ...
    public static void main(String[] args) throws InterruptedException, FileNotFoundException {
        ...
        while(true) {   //цикл для запроса на повтор 
            ...
            try (PrintWriter pw = new PrintWriter(file)) {//запись в файл
                ...
                System.out.println("Данные хранятся в файле <--Данные в текстовом файле-->");Thread.sleep(300);
                ...
                if(strsw1 == true || strsw2 == true || strsw3 == true || strsw4 == true) {
                    if(strsw1 == true || strsw2 == true) {
                        ...
                        for(int i = 0; i < 3; i++) {
                            for(int j = 0; j < 3; j++) {
                                int q = i + 1, r = j + 1;
                                System.out.print("\tДанные матрицы А"+q+r+" - ");
                                e[i][j] = in.nextInt();pw.println("\tДанные матрицы А"+r+q+" - "+e[i][j]);
                            }
                        }
                    ...
                    if(str1 == true || str2 == true){//цикл для no
                ...
                System.out.println("--------------------\nВычисляем определитель матрицы:");Thread.sleep(300);
                pw.println("--------------------\nВычисляем определитель матрицы:");Thread.sleep(200);
                float opred1 = e[0][0] * e[1][1] * e[2][2];
                float opred2 = e[0][1] * e[1][2] * e[2][0];
                float opred3 = e[0][2] * e[1][0] * e[2][1];
                float opred4 = e[0][2] * e[1][1] * e[2][0];
                ...
                System.out.printf("%4.0f",opred);
                pw.println(opred);
                System.out.println("\nНаходим матрицу алебраических дополнений А:");Thread.sleep(200);
                ...
                System.out.println("--------------------");
                pw.println("--------------------");Thread.sleep(300);
                System.out.println("Обратнаяматрица: ");
                pw.println("Обратнаяматрица: ");
                ...
                pw.println("Конец.");Thread.sleep(300);
                ...
                if(strs1 == true || strs2 == true){//циклдля no
                    ...
                    System.out.print("Выввелинеправильнозначение, перезапуститекод. Хотите ли вы перезапустить код?[Y/N(любая клавиша)] --> ");
